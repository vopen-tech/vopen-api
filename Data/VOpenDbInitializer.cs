...
namespace vopen_api.Data
{
    public static class VOpenDbInitializer
    {
        ...
        public static async Task Seed(DbContextOptions<VOpenDbContext> options)
        {
                ...
                var aryBuyLinks = new List<TicketLink>()
            {
                    ...
                    EditionTickets = new List<EditionTicket>()
                {
                    ...
                    Activities = await VOpenDbInitializer.GetArEditionActivities(context),
                };
        ...
        public static async Task<ICollection<EditionActivity>> GetArEditionActivities(VOpenDbContext context)
        {
            ...
            var uySpeaker4 = await context.Users.FirstOrDefaultAsync(c => c.Id == JAVIER_VILLEGAS_ID);
